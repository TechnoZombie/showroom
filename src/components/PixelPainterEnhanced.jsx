...
const PixelPainterEnhanced = () => {
    return (
        <div className="readme-container">
                ...
                <p>A Java-based pixel art creation tool that combines simplicity with powerful features. PixelPainter provides an intuitive grid-based canvas where users can create pixel art through a combination of keyboard controls and mouse interactions (work in progress).</p>

                <p>This project is a continuation of the original PixelPainter project, with additional features and improvements. The main goal was to implement a GUI for the application, making it more user-friendly and accessible. It then grew large enough to be its own project and repository. The original can be found here: <a href="https://github.com/TechnoZombie/PixelPainter">https://github.com/TechnoZombie/PixelPainter</a>.</p>

                <p>It also makes use of a <a href="https://github.com/TechnoZombie/Simplegraphz">custom graphics library</a>, based on <a href="https://github.com/academia-de-codigo/simple-graphics">simple-graphics</a> where custom methods to allow for JFrame manipulation were added, as well as Lombok and Slf4j.</p>

                <h2>Project Overview</h2>

                <p>PixelPainter is built with a focus on clean architecture and modular design. The application utilizes the SimpleGraphZ library for graphics rendering and implements a robust event-handling system for user interactions.</p>
                ...
                <ul>
                    ...
                    <li><strong>Color Processing:</strong> Custom color handling system with RGB conversion capabilities</li>
                ...
                <p>Currently in active development with regular updates and improvements. The core functionality is stable and fully operational.</p>

                <p>PixelPainter is a demonstration of modern Java application design, combining practical functionality with clean architecture and efficient implementation.</p>
